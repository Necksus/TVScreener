...
namespace TVScreener.ZoneBourse
{
    public class Stock
    {
        ...
        public string TradingViewCode => !string.IsNullOrEmpty(Exchange) ? $"{Exchange}:{Code.Replace(" ", "_")}" : Code;
        ...
        private string GetExchange(string zoneBourseExchange, string currency)
        {
